...
function HomeAboutSection() {
    return (
        <div className={""}>
            ...
            <button className={"bg-gradient-to-r from-main-80 to-main-100 mt-1 p-2 px-5 font-semibold text-gray-200"}>About Me</button>
            ...
            <div className={"flex flex-row text-4xl space-x-1.5 flex-wrap max-w-[100%]"}>
                ...
                <SiGithub className={"text-gray-400 hover:scale-[1.10] ease-in-out duration-200"}/>
